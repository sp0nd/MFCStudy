...
CMFCApplication1Dlg::CMFCApplication1Dlg(CWnd* pParent /*=nullptr*/)
	...
	, m_strNAME(_T("김태준"))
	, m_strMobileTel(_T("010101010101"))
	, m_strOfficeTel(_T("1000000000"))
	, m_strHomeTel(_T("1000000000000"))
	, m_stremail(_T("11111111111111111"))
	, m_strBirth(_T("2222222222222"))
{
...
void CMFCApplication1Dlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Text(pDX, IDC_EDIT4, m_strMobileTel);
	DDX_Text(pDX, IDC_EDIT5, m_strOfficeTel);
	DDX_Text(pDX, IDC_EDIT6, m_strHomeTel);
	DDX_Text(pDX, IDC_EDIT7, m_stremail);
	DDX_Text(pDX, IDC_EDIT8, m_strBirth);
}
...
BEGIN_MESSAGE_MAP(CMFCApplication1Dlg, CDialogEx)
	...
	ON_BN_CLICKED(IDC_DATALOAD, &CMFCApplication1Dlg::OnBnClickedDataload)
	ON_BN_CLICKED(IDC_DATAINSERT, &CMFCApplication1Dlg::OnBnClickedDatainsert)
	ON_BN_CLICKED(IDC_DATAMODIFY, &CMFCApplication1Dlg::OnBnClickedDatamodify)
	ON_BN_CLICKED(IDC_DATADELETE, &CMFCApplication1Dlg::OnBnClickedDatadelete)
	ON_BN_CLICKED(IDC_DATASAVE, &CMFCApplication1Dlg::OnBnClickedDatasave)
...
void CMFCApplication1Dlg::OnBnClickedDataload()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
	AfxMessageBox(_T(""));
}
...
void CMFCApplication1Dlg::OnBnClickedDatainsert()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
	AfxMessageBox(_T(""));
}
...
void CMFCApplication1Dlg::OnBnClickedDatamodify()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
	AfxMessageBox(_T(""));
}
...
void CMFCApplication1Dlg::OnBnClickedDatasave()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
}
